...
class PrimeLondonController extends Controller
{
    ...
    private const CATEGORY = 'Prime Central';

    private const CACHE_PREFIX = 'pcl:home:rolling';
    ...
    public function home()
    {
        ...
        return view('prime.home', [
            ...
            'heroDescription' => 'Analysis of London\'s prestigious postcodes. <span class="font-semibold">Category A sales only</span>. This represents the widely accepted postcodes in the Prime areas. Some will refine that down further to specific streets or neighbourhoods, but for this site it\'s suitable for a broad overview.',
            'lastWarmCacheKeys' => [$lastWarmCacheKey],
            'allDistrictLabel' => 'All Prime Central',
            'emptyDistrictMessage' => 'No Prime Central districts found.',
            'allDistrictOverviewTitle' => 'All Prime Central - Overview',
            'allDistrictOverviewDescription' => 'This section aggregates <strong>all Prime Central London postcodes</strong> into a single area for year-by-year analysis.',
