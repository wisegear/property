...
@section('content')
    <section class="relative z-0 -mx-6 -mt-6 overflow-hidden bg-white py-8 shadow-[0_1px_0_rgba(0,0,0,0.06)] md:py-9">
        <div class="relative z-10 mx-auto grid max-w-7xl items-center gap-6 px-4 md:grid-cols-[minmax(0,1fr)_minmax(280px,0.42fr)] md:gap-8">
            <div class="max-w-4xl">
                <p class="flex items-center gap-2 text-xs font-semibold uppercase tracking-[0.24em] text-zinc-500"><span class="h-2 w-2 rounded-full bg-lime-500"></span>Market health</p>
...
<div class="mx-auto max-w-7xl px-4 py-8 md:py-10">
    ...
    <section class="mb-8 rounded-sm border border-zinc-200 bg-white p-5 shadow-sm md:p-6">
        <div class="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
            ...
            <div class="grid grid-cols-2 gap-3 text-sm sm:grid-cols-4">
                <div class="rounded-sm border border-emerald-200 bg-emerald-50 px-4 py-3">
                ...
                <div class="rounded-sm border border-rose-200 bg-rose-50 px-4 py-3">
                ...
                <div class="rounded-sm border border-rose-300 bg-rose-100 px-4 py-3">
    ...
    <section class="grid grid-cols-1 gap-5 lg:grid-cols-2">
        @foreach ($cards as $card)
            <article class="flex h-full flex-col overflow-hidden rounded-sm border p-5 shadow-sm {{ $card['status']['card'] }}">
                ...
                <div class="mt-6 flex flex-1 flex-col gap-5">
                    <div class="space-y-4">
                        ...
                        <details class="rounded-sm border border-zinc-200 bg-white/70 px-4 py-3">
                    ...
                    <div class="mt-auto rounded-sm border border-white/70 bg-white/80 p-4">
