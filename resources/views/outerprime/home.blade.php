        ...
        <div class="max-w-4xl">
            ...
            <p class="mt-1 text-sm leading-6 text-gray-700">
                ...
                <span class="ml-2 text-neutral-600">|
                    ...
                    @php
                        $ts = $lastCachedAt
                            ?? \Illuminate\Support\Facades\Cache::get('outerprime:v4:catA:last_warm')
                            ?? \Illuminate\Support\Facades\Cache::get('outerprime:v3:catA:last_warm')
            ...
            <section class="mb-10 district-section" data-district="{{ $district }}">
                ...
                <div class="flex flex-col gap-3 sm:gap-4 md:grid md:grid-cols-2">
                    ...
                    <div class="rounded-lg border p-4 bg-white col-span-2 overflow-hidden h-64 sm:h-72 md:h-80">
                        <h3 class="font-semibold mb-2">Median & Outer‑Prime Indicators in {{ $__label }}</h3>
            ...
            if (apCtx) {
                ...
                new Chart(apCtx, { 
                    ...
                    data: { 
                        labels: years, 
                        datasets: [
                            { label: 'Median Price (£)', data: apData, pointRadius: 3, tension: 0.2 }
                        ]
                    }, 
                    options: { 
                        animation: false, 
                ...
                new Chart(apiCtx, { 
                    ...
                    data: { 
                        ...
                        datasets: [
                            ...
                            { label: 'Top 5% Avg (£)', data: top5Data, pointRadius: 2, borderWidth: 1, tension: 0.15 }
                        ]
                    }, 
                    options: { 
                        animation: false, 
